...
export function ShowcaseCard({ business }: { business: BusinessCard }) {
  return (
    <Link
      ...
      className="group block shrink-0 overflow-hidden rounded-[22px] bg-card shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_28px_-14px_rgba(0,0,0,0.18)] transition-shadow hover:shadow-[0_1px_2px_rgba(0,0,0,0.06),0_20px_36px_-16px_rgba(180,35,243,0.28)]"
    >
